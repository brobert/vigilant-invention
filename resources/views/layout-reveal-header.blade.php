...
<html class="backend">
    ...
    <body>
       <!-- START Template Header -->
        <header id="header" class="navbar animation" data-toggle="waypoints" data-showanim="fadeInDown" data-hideanim="fadeOutUp" data-offset="-70px">
            <!-- START navbar header -->
            ...
            <div class="container-fluid" style="min-height:1024px;"><!-- add min-height to simulate scrolling -->
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Layout Reveal Header</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <li class="active">Reveal Header</li>
                            </ol>
                        </div>
                        <!--/ Toolbar -->
                    </div>
